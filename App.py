...
if page == "Home":
    ...
    st.markdown("""
This project is a **collaborative initiative** between the following institutions:

- 🧠 **Amity Centre for Artificial Intelligence (ACAI)**, Amity University Noida  
- 🌾 **ICAR - National Institute of Biotic Stress Management (NIBSM)**, Baronda, Chhattisgarh

The objective is to assist researchers and farmers with an intelligent diagnostic tool for mustard crop health, focusing on **aphid severity detection** using deep learning and attention-based CNNs.
